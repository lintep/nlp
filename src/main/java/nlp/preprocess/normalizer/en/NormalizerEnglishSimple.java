...
//		System.out.println(tools.util.File.getCurrentDirectory());
		NormalizerEnglishSimple normalizerEnglishSimple=new NormalizerEnglishSimple();		
		System.out.println(normalizerEnglishSimple.normalize("He is 'scsdf'#$% a book DIIIIIIDI.", true));
		System.out.println(normalizerEnglishSimple.normalize("He is 'scsdf'#$% a book DIIIIIIDI.", false));
	}

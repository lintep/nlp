...
public class TokenizerEnglishSimple {
	...
	public static void main(String[] args) throws IllegalArgumentException,
		...
		// System.out.println(tools.util.File.getCurrentDirectory());
		// TokenizerEnglishSimple normalizerEnglishSimple=new
		// TokenizerEnglishSimple();
		// System.out.println(normalizerEnglishSimple.normalize("He is 'scsdf'#$% a book DIIIIIIDI.",
		// true));
		// System.out.println(normalizerEnglishSimple.normalize("He is 'scsdf'#$% a book DIIIIIIDI.",
		// false));
		String str = "statisticalmachinetranslation";
		// System.out.println(str.substring(2, 4));
		String tokenDist = "/home/saeed/Desktop/text pdf/univercity pdf/pathToken/token.joint/tokenizer.token";
//		HashMap<String, Integer> validTokens = tools.util.file.Reader
//				.getKeyValueStringIntegerFromTextFile(tokenDist, 0, false, "\t");
		TokenizerEnglishSimple tokenizerEnglishSimple = new TokenizerEnglishSimple(100,true);
//				validTokens);
		System.out.println(str + "\t ->\n"
				+ tokenizerEnglishSimple.tokenize(str));
//		 int i=0;
//		 for (String string :
//		 tools.util.file.Reader.getStringFromTextFile("/home/saeed/Desktop/text pdf/univercity pdf/pathToken/path.normalize.morthan20",
//		 false)) {
//		 i++;
//			System.out.println("\n\n" + i + ") " + string + "\t ->\n"
//					+ tokenizerEnglishSimple.tokenize(string,100));
//		 tools.util.ConsuleInput.readStringUTF8();
//		 }
	}

//	private static final String termtokensDistributionFileAddress = tools.util.File
//			.getParent(tools.util.File.getParent(tools.util.File
//					.getCurrentDirectory()))
//			+ "/NLP/src/nlp/preprocess/tokenizer/en/rawTermToken.dist";
...
//	HashMap<String, Integer> tokensDistribution;
	...
	private void getTokens(Integer minFrequency) {
		if (checkNumber(currentToken)) {
			...
			default:
//				if (this.tokensDistribution.containsKey(currentToken)) {
//					sentence.append(currentToken);
//					sentence.append(' ');
//				} else {
//				if(cleanedToken){
//					if(this.tokensDistribution.get(currentToken)>=minFrequency){
//						sentence.append(currentToken);
//								sentence.append(' ');
//
//					}
...
//				}
	...
	// StringBuilder tempTerm[0]=new StringBuilder();int i1=0;//long
	// tempPhreaseScoreArray[0]=0l;
	// StringBuilder tempTerm[1]=new StringBuilder();int i2=0;//long
	// tempPhreaseScoreArray[1]=0l;
	// StringBuilder tempTerm[2]=new StringBuilder();int i3=0;//long
	// tempPhreaseScoreArray[2]=0l;
	// StringBuilder tempTerm[3]=new StringBuilder();int i4=0;//long
	// tempPhreaseScoreArray[3]=0l;
	// StringBuilder tempTerm[4]=new StringBuilder();int i5=0;//long
	// tempPhreaseScoreArray[4]=0l;
	// StringBuilder tempTerm[5]=new StringBuilder();int i6=0;//long
	// tempPhreaseScoreArray[5]=0l;
	int i1 = 0;
	int i2 = 0;
	int i3 = 0;
	int i4 = 0;
